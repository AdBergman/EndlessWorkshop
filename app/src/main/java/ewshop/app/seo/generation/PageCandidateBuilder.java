...
@Component
public class PageCandidateBuilder {

    public List<PageCandidate> buildPageCandidates(CodexFilterResult filterResult) {
    ...
    private static List<PageCandidate> toVariantAwareCandidates(List<CodexFilterResult.FilteredCodexEntry> group) {

...
| ---: | --- | --- | --- | ---: | --- | ---: | ---: | --- | --- | --- |
| 1 | traits | Granted abilities | compact rendered preview | 1 | 2/2 resolved, 0 unresolved, 2 duplicate structured refs | 6 | 3 | EWShop | Candidate | Heightened Senses (FactionTrait_Custom_Specific36) |
| 2 | actions | Related Status/effect entries | compact rendered preview | 3 | 6/42 resolved, 36 unresolved, 3 duplicate structured refs | 6 | 5 | Both | Needs exporter/editorial context first | Mukag Light01 (EmpireActionTypeMukag_Light01)<br>Mukag Light02 (EmpireActionTypeMukag_Light02)<br>Mukag Light03 (EmpireActionTypeMukag_Light03) |
| 3 | factions | Related Status/effect entries | one-line summary/card | 1 | 2/6 resolved, 4 unresolved, 0 duplicate structured refs | 6 | 5 | Both | Needs product review to avoid bloat | Necrophages (Faction_Necrophage) |
| 4 | traits | Unlock relationships | one-line summary/card | 41 | 30/39 resolved, 9 unresolved, 39 duplicate structured refs | 5 | 4 | EWShop | Candidate after preview-surface product review | Harmonious Tactics (FactionTrait_Aspects_BattleAffinity)<br>Deadly Corals (FactionTrait_Aspects_Chapter05AStep01_FactionQuest)<br>Radiance (FactionTrait_Aspects_Chapter05AStep02_FactionQuest) |
| 5 | quests | Faction references | one-line summary/card | 166 | 332/354 resolved, 22 unresolved, 0 duplicate structured refs | 3 | 3 | EWShop | Usually already served by related-entry chips; avoid inline dossiers | The Great Dieback (FactionQuest_Aspect_Chapter01_Step01)<br>The Great Dieback (FactionQuest_Aspect_Chapter01_Step02)<br>Not of the Chorus (FactionQuest_Aspect_Chapter02_Step01) |
...
| 10 | populations | Faction references | one-line summary/card | 6 | 12/12 resolved, 0 unresolved, 0 duplicate structured refs | 3 | 3 | EWShop | Usually already served by related-entry chips; avoid inline dossiers | Aspect (Population_Aspect)<br>Kin of Sheredyn (Population_KinOfSheredyn)<br>Last Lord (Population_LastLord) |
...
Common facts: Category (336), Kind (336), Ability mechanic (328), Ability source (252), Combat role (188), Range (100), Target (100), Cost (92)
...
Facts-only/no mechanics entries: 24/336 entries.
...
| Facts only, no player-facing mechanics | no action | 24 | 0/0 resolved, 0 unresolved, 0 duplicate structured refs | 1 | 8 | Exporter/editorial | Preview UI cannot create missing player context |
...
Common sections: Action mechanics (55)

Common section item labels: Influence cost multiplier (31), Money cost multiplier (15), Production cost (12), Duration (8), Cooldown (6), Empire project cost (5), Influence cost (5), Money cost (4)
...
Facts-only/no mechanics entries: 84/139 entries.

| Useful subcategory | Entries | Example entries |
| --- | ---: | --- |
| Action | 73 | Absorb City (ActionTypeAbsorbCity)<br>Army Steal Territory (ActionTypeArmyStealTerritory)<br>Assimilation (ActionTypeAssimilation) |
...
| Facts only, no player-facing mechanics | no action | 84 | 0/0 resolved, 0 unresolved, 0 duplicate structured refs | 1 | 8 | Exporter/editorial | Preview UI cannot create missing player context |
...
Common facts: Affected cost (248), Category (248), Kind (248), Modifier (248)

Common sections: Bonus mechanics (248), Effects (1)

Common section item labels: Production -25% (17), Research -50% (8), Production -10% (7), Influence -25% (6), Production -15% (6), Research -20% (6), Buyout -20% (5), Buyout -25% (5)
...
Duplicated structured relationships: 351 structured reference keys also appear in public/reference keys.

Direct Effects section coverage: 1/248 entries.

Facts-only/no mechanics entries: 0/248 entries.

| Useful subcategory | Entries | Example entries |
| --- | ---: | --- |
| Cost Modifier | 248 | Worldmending (ActionCostModifer_CloseRift_Decree_Discovery_02_00)<br>Close Rift turn cost -33% (ActionCostModifer_CloseRift_Decree_Discovery_07_00)<br>Bribe Village money cost -25% (ActionCostModifer_FactionQuest_LastLord_Chapter03B) |
...
Duplicated structured relationships: 65 structured reference keys also appear in public/reference keys.
...
| Candidate relationship | Surface | Entries | Resolution | Player value | Risk | Owner | Status |
| --- | --- | ---: | --- | ---: | ---: | --- | --- |
| Threshold reward targets | one-line summary/card | 25 | 64/64 resolved, 0 unresolved, 64 duplicate structured refs | 0 | 1 | None | Implemented in EWShop for resolved exact Population threshold refs; unresolved refs need exporter/editorial cleanup |
...
Common facts: Category (300), Kind (300), Mandatory (297), Chapter (195), Faction (15)

Common sections: Choices (288), Objective (283), Rewards (136), Requirements (93), Effects (6)

Common section item labels: Collect 3 curiosities (15), Build 1 constructible(s) (6), Collect 3 tagged curiosities (6), Interact with Site of the Ancients (6), Matriarch's Glands (6), Shield Mastery II (6), Bow of the Starfarers (5), Interact with Hermit's Abode (5)

Related targets: quests (215), factions (166), equipment (101), tech (19), heroes (17), minorfactions (15), populations (7), abilities (6)

Resolved-vs-unresolved related entries: 11 unresolved public/reference keys observed.

Duplicated structured relationships: 140 structured reference keys also appear in public/reference keys.

Direct Effects section coverage: 6/300 entries.

Facts-only/no mechanics entries: 0/300 entries.
...
| Awakening / Quest | 12 | Something on the Shore (AwakeningQuest_CustomFaction01_Step01)<br>I Come Bearing Gifts (AwakeningQuest_CustomFaction01_Step02_Choice01)<br>The Sins of the Fathers (AwakeningQuest_CustomFaction01_Step02_Choice02) |

| Candidate relationship | Surface | Entries | Resolution | Player value | Risk | Owner | Status |
| --- | --- | ---: | --- | ---: | ---: | --- | --- |
| Faction references | one-line summary/card | 166 | 332/354 resolved, 22 unresolved, 0 duplicate structured refs | 3 | 3 | EWShop | Usually already served by related-entry chips; avoid inline dossiers |
...
Common sections: Effects (104), Unlocks (41), Exclusions (3), Granted abilities (1)

Common section item labels: Iron Games I (3), Laboratory (3), Aware (2), Farm (2), Fencing (2), Forum (2), Merchant's House (2), Works (2)

Related targets: minorfactions (30), traits (28), units (20), tech (19), districts (12), improvements (9), heroes (5), abilities (1)

Resolved-vs-unresolved related entries: 17 unresolved public/reference keys observed.

Duplicated structured relationships: 50 structured reference keys also appear in public/reference keys.

Direct Effects section coverage: 104/178 entries.
...
| Candidate relationship | Surface | Entries | Resolution | Player value | Risk | Owner | Status |
| --- | --- | ---: | --- | ---: | ---: | --- | --- |
| Granted abilities | compact rendered preview | 1 | 2/2 resolved, 0 unresolved, 2 duplicate structured refs | 6 | 3 | EWShop | Candidate |
| Unlock relationships | one-line summary/card | 41 | 30/39 resolved, 9 unresolved, 39 duplicate structured refs | 5 | 4 | EWShop | Candidate after preview-surface product review |

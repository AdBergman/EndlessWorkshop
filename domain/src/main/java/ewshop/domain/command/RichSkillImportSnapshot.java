...
public record RichSkillImportSnapshot(
    ...
    public RichSkillImportSnapshot {
    ...
    private static String require(String value, String field) {
        ...
        if (trimmed == null) {
            throw new IllegalArgumentException("RichSkillImportSnapshot." + field + " is required");
        }
        return trimmed;
    }
    ...
    private static List<String> cleanList(List<String> values) {
        ...
        return values.stream()
                .map(RichSkillImportSnapshot::trimToNull)

...
public record HeroImportSnapshot(
        String unitKey,
        String displayName,
        String faction,
        String factionKey,
    ...
    private static String require(String value, String field) {
        ...
        if (trimmed == null) {
            throw new IllegalArgumentException("HeroImportSnapshot." + field + " is required");
        }
        return trimmed;
    }
    ...
    private static List<String> cleanList(List<String> values) {
        ...
        return values.stream()
                .map(HeroImportSnapshot::trimToNull)

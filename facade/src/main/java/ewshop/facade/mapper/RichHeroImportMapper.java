...
public final class RichHeroImportMapper {

    private RichHeroImportMapper() {}

    public static RichHeroImportSnapshot toSnapshot(HeroImportHeroDto dto) {
        ...
        return new RichHeroImportSnapshot(
                unitKey,
    ...
    private static List<String> cleanList(List<String> values) {
        ...
        return values.stream()
                .map(RichHeroImportMapper::trimToNull)

...
class SkillImportAdminFacadeImplTest {
    ...
    void importSkillsPreservesPublicDisplayNameAndSkillRelationships() {
        ...
        SkillImportAdminFacadeImpl facade = new SkillImportAdminFacadeImpl(importService, skillService);
        ...
        SkillImportSnapshot snapshot = importService.snapshots.getFirst();
    ...
    private static final class RecordingImportService extends SkillImportService {
        private final List<SkillImportSnapshot> snapshots = new ArrayList<>();
    ...
    private static final class RecordingSkillService extends SkillService {
        ...
        public Skills getAllSkills() {
            getAllCalls++;
            return new Skills(List.of(), List.of(), List.of(), List.of());
        }
    }
}

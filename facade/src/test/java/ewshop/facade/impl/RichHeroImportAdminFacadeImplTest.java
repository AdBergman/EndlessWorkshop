...
class RichHeroImportAdminFacadeImplTest {
    ...
    void importHeroesPreservesUnitsCollectionShapeAndExactKeys() {
        ...
        RichHeroImportAdminFacadeImpl facade = new RichHeroImportAdminFacadeImpl(importService, heroService);
        ...
        RichHeroImportSnapshot snapshot = importService.snapshots.getFirst();
    ...
    private static final class RecordingImportService extends RichHeroImportService {
        private List<RichHeroImportSnapshot> snapshots = List.of();
    ...
    private static final class RecordingHeroService extends RichHeroService {

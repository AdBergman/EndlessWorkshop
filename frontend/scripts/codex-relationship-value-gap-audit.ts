...
function formatMarkdown(entries: EntryWithKind[]): string {
    ...
    const gaps: RelationshipGap[] = [
        {
            ...
            owner: "Exporter/editorial for unresolved or text-only unlocks; EWShop exact-ref summaries are implemented",
            productTreatment: "Keep Tech top-level; exact Unlock summaries are implemented for resolved refs only.",
        },
        {
        ...
        },
        {
            ...
            productTreatment: "Keep Extractors under Districts; Resources are top-level shallow reference entries.",
        },
        {
            ...
            owner: "EWShop/product, with exporter/editorial for thin entries",
            productTreatment: "Resources are top-level shallow reference entries; thin entries need exporter/editorial context.",
        },
        {
            area: "Thin Actions",
        ...
        },
        {
            ...
            owner: "Both",
            productTreatment: "Exact Applied Status summaries are implemented; remaining gaps are mostly direct Effects/editorial text.",
        },
        {
    ...
    const lines = [
        ...
        "",
        ...renderNumbered([
            "Browser-QA Population threshold summaries against current exact refs to catch regressions.",
            "Harden Quest Strategy Codex preview accessibility if keyboard or touch QA finds friction.",
            "Browser-review Action mechanics presentation for entries that already have useful mechanics sections.",
            "Continue keeping completed preview surfaces exact-ref-only and implementation-aware in diagnostics.",
            "Review Status grouping/filtering only after exporter provides usable Status sub-kind/scope data.",
        ]),
        "",

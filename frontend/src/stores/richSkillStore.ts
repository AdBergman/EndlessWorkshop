...
import type { RichHeroSkill, RichHeroSkillDefault, RichSkillTier, RichSkillTree, RichSkills } from "@/types/dataTypes";
...
type RichSkillStore = {
    ...
    skillTreesByKey: Record<string, RichSkillTree>;
    skillTiers: RichSkillTier[];
    skillTiersByKey: Record<string, RichSkillTier>;
    skills: RichHeroSkill[];
    skillsByKey: Record<string, RichHeroSkill>;
    heroSkillDefaults: RichHeroSkillDefault[];
    heroSkillDefaultsByHeroKey: Record<string, RichHeroSkillDefault>;
    ...
    reset: () => void;
    replaceSkills: (skills: RichSkills) => void;
    getSkillByKey: (key: string) => RichHeroSkill | undefined;
    getSkillTreeByKey: (key: string) => RichSkillTree | undefined;
};
...
const normalizeTree = (tree: RichSkillTree): RichSkillTree => ({
    ...tree,
...
const normalizeTier = (tier: RichSkillTier): RichSkillTier => ({
    ...tier,
...
const normalizeSkill = (skill: RichHeroSkill): RichHeroSkill => ({
    ...skill,
...
const normalizeDefault = (defaultSkill: RichHeroSkillDefault): RichHeroSkillDefault => ({
    ...defaultSkill,
...
const initialState = {
    skillTrees: [] as RichSkillTree[],
    skillTreesByKey: {} as Record<string, RichSkillTree>,
    skillTiers: [] as RichSkillTier[],
    skillTiersByKey: {} as Record<string, RichSkillTier>,
    skills: [] as RichHeroSkill[],
    skillsByKey: {} as Record<string, RichHeroSkill>,
    heroSkillDefaults: [] as RichHeroSkillDefault[],
    heroSkillDefaultsByHeroKey: {} as Record<string, RichHeroSkillDefault>,
    loading: false,
    loaded: false,
...
const buildState = (raw: RichSkills) => {
...
export const useRichSkillStore = create<RichSkillStore>((set, get) => ({
    ...initialState,

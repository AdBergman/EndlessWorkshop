...
export default function QuestTranscript({ blocks }: QuestTranscriptProps) {
    return (
        <section className="questExplorer-transcript" aria-labelledby="quest-transcript-heading">
            <div className="questExplorer-sectionLabel" id="quest-transcript-heading">
                Archive Transcript
            </div>

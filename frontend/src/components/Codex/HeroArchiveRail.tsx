...
type Props = {
    activeFilters: ActiveHeroArchiveFilters;
    groups: readonly HeroArchiveFilterGroup[];
    onClearFilters: () => void;
    onToggleFilter: (filterKey: HeroArchiveFilterKey, value: string) => void;
};
...
export default function HeroArchiveRail({
    activeFilters,
    groups,
    onClearFilters,
    onToggleFilter,
}: Props) {
    const hasActiveFilters = Boolean(activeFilters.class || activeFilters.faction);

    return (
        <div className="codex-resultsFilters" aria-label="Hero filters">

import { District, Improvement, Tech, Unit, Codex, RichFaction, RichHero, RichSkills } from "@/types/dataTypes";
...
export const apiClient = {
    ...
    getHeroes: () => fetcherJson<RichHero[]>("/heroes"),
    getSkills: () => fetcherJson<RichSkills>("/skills"),
